<div>
    <form wire:submit="save">
        ...
        <input id="video-name" type="text" wire:model="name" required>
        <label for="video-status">Status</label>
        <select id="video-status" wire:model="status">
        ...
        <label for="video-payload">Payload (JSON)</label>
        <textarea id="video-payload" wire:model="payload"></textarea>
